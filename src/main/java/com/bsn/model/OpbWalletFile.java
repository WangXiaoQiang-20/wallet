 ...
 * Desc：
 *
 * @Created by 2022-01-20 16:53
 */
public class OpbWalletFile {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OpbWalletFile)) {
            return false;
        }

        OpbWalletFile that = (OpbWalletFile) o;
    ...
    public static class Crypto {
        ...
        @JsonTypeInfo(
                ...
                property = "kdf")
        @JsonSubTypes({
                @JsonSubTypes.Type(value = Aes128CtrKdfParams.class, name = OpbWallet.AES_128_CTR),
                @JsonSubTypes.Type(value = ScryptKdfParams.class, name = OpbWallet.SCRYPT)
        })
